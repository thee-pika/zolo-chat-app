...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "password" | "avatar" | "publicId" | "bio", ExtArgs["result"]["user"]>
  ...
  interface ChatFieldRefs {
    ...
    readonly members: FieldRef<"Chat", 'String[]'>
  ...
  export type ChatWhereInput = {
    ...
    creator?: StringNullableFilter<"Chat"> | string | null
  ...
  export type ChatScalarWhereWithAggregatesInput = {
    ...
    creator?: StringNullableWithAggregatesFilter<"Chat"> | string | null
    members?: StringNullableListFilter<"Chat">
  ...
  export type ChatUpdatemembersInput = {
    set?: string[]
    push?: string | string[]
  }
